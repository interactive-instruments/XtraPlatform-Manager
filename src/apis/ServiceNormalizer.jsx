...
var serviceProps = commonProps.concat(['serviceType', 'label', 'description', 'status', 'featureTypes', 'capabilities', 'lastModified', 'createdAt', 'featureProvider', 'hasBackgroundTask', 'progress', 'message']);
